...
module.exports = app => {
	...
	Module.associate = function() {
		// app.model.Module.hasMany(app.model.RolePermission, { foreignKey: "module_id" });
		app.model.Module.belongsToMany(app.model.Role, { through: app.model.RolePermission, foreignKey: "module_id" });
	};
